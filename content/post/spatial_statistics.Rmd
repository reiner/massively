...
The two raster-datasets are available for download. Followingly, we provide some code to load it into R and to take a first glipmse at it. 
...
# population data - values for raster-cells with population totals > 10 are 
